...
const services = [
  {
    icon: Activity,
    title: "Blood Tests",
    description: "CBC, lipid profile, diabetes screening.",
    tests: "50+ tests",
  },
  {
    icon: Heart,
  ...
  },
  {
    icon: Microscope,
    title: "Pathology",
    description: "Urine, stool, culture tests, biopsies.",
    tests: "40+ tests",
  },
  {
    icon: Bone,
    title: "Radiology",
    description: "Bone density and specialized imaging.",
    tests: "10+ tests",
  },
  {
    icon: FileText,
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="mb-12 text-center">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Book diagnostic tests online and receive reports digitally from
        ...
        <CardContent className="p-8">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold mb-6 text-center">
              Why Choose WellSpace Diagnostics?
            </h2>
                ...
                <div key={item} className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Built to connect your diagnostic journey with
