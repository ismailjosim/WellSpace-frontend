...
const ngoCategories = [
  {
    ...
    description: "Medical camps and health education.",
    count: "25+ NGOs",
  },
  {
    icon: HandHeart,
  ...
  },
  {
    ...
    description: "Groups funding medical research and innovation.",
    count: "10+ institutions",
  },
  {
    icon: Globe,
    title: "International Aid",
    description: "Global health organizations working locally.",
    count: "12+ NGOs",
  },
];
                ...
                <div key={step} className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Discover community support resources and healthcare access
                      programs.
                    </p>
                  </div>
                </div>
      ...
      <Card className="bg-linear-to-br from-primary/10 to-secondary/10 border-primary/20">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Healthcare NGOs will be able to register and reach more people
            through WellSpace.
          </p>
